    ...
    <div className="flex flex-col md:items-start sm:items-center md:text-left sm:text-center space-y-6 relative">
      ...
      >
        <p className="text-lg">
          ...
          with a strong focus on uncovering insights and building predictive models using{" "}
          <span className="text-cyan font-semibold">Python</span>. 
          I love crafting clean, efficient, and data-driven solutions to solve complex real-world problems.
        </p>
        ...
        <p className="text-lg">
          ...
          {" "}and statistical analysis, learning the full{" "}
          <span className="text-orange font-semibold">data science lifecycle</span>{" "}
          to become a well-rounded data professional. I&apos;m constantly exploring technologies like{" "}
          <span className="text-green font-mono text-sm">SQL</span>,{" "}
          <span className="text-cyan font-mono text-sm">Scikit-learn</span>, and{" "}
          <span className="text-green font-mono text-sm">Tableau</span>{" "}
        ...
        <p className="text-lg">
          ...
          <span className="text-yellow font-semibold">building impactful data stories</span>. 
          Let&apos;s create something insightful together!
        </p>
      </motion.div>
