...
const HeroText = () => {
  ...
  return (
    <div className="flex flex-col gap-6 h-full justify-center md:text-left sm:text-center relative">
      ...
      >
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan to-green font-semibold">Data Science</span>{" "}
        <span className="text-white/60">&amp;</span>{" "}
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-green to-cyan font-semibold">Machine Learning</span>{" "}
        Student
      </motion.h2>
      ...
      >
        ...
        <div className="absolute inset-0 text-green/20 animate-pulse blur-sm">
          ARIJIT<br className="sm:hidden md:block" />MANDAL
        </div>
      </motion.h1>
      ...
      >
        <p className="text-lg text-white/80 leading-relaxed">
          ...
          student with experience in building{" "}
          <span className="text-cyan font-semibold">predictive models</span>{" "}
          and{" "}
