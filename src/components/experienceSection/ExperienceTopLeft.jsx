    ...
    >
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-gray-300 leading-relaxed text-sm">
          With <span className="text-green font-semibold">2+ years</span> of technical experience,
          I&apos;ve successfully delivered
          <span className="text-cyan font-semibold"> 6+ projects</span> focused on
          data-driven automation, predictive modeling, and analytical web tools that turn complex datasets into actionable insights.
        </p>

        <div className="flex flex-wrap justify-center gap-2 mt-4">
          {['Python', 'SQL', 'Scikit-learn', 'Tableau', 'Pandas'].map((tech, index) => (
            <span
              key={index}
