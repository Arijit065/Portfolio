    ...
    >
      ...
      <div className="space-y-4">
        <p className="text-gray-300 leading-relaxed text-center">
          ...
          , leveraging statistical modeling and machine learning best practices to create scalable, data-driven solutions.
        </p>
        ...
        <p className="text-gray-300 leading-relaxed text-center text-sm">
          My academic and project experience spans working on diverse challenges, from statistical data analysis
          to{" "}
          <span className="font-bold text-green">
            complex machine learning models
          </span>
          , always aiming to derive meaningful insights from raw data.
        </p>
      </div>
